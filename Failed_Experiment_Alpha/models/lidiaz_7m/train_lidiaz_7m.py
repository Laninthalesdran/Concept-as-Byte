...
CHECKPOINT_DIR = os.path.join(BASE_DIR, 'lidiaz_7m_checkpoints')
LOG_FILE = os.path.join(BASE_DIR, 'lidiaz_7m_training.log')
...
def train():
    ...
    logger.info("=" * 60)
    logger.info("LidiaZ 7M (Matched Config) — Ludwik Zamenhof Method")
    logger.info("=" * 60)
