"""BPE Baseline B — Parallel, BPE tokenized. 3 epochs. Control model."""
...
TRAINING_BIN = os.path.join(os.path.dirname(__file__), 'bpe_b_training.bin')
CHECKPOINT_DIR = os.path.join(os.path.dirname(__file__), 'bpe_b_checkpoints')
LOG_FILE = os.path.join(os.path.dirname(__file__), 'bpe_b_training.log')
...
def train():
    ...
    logger.info("=" * 60); logger.info("BPE Baseline B — Parallel, BPE tokenized"); logger.info("=" * 60)
