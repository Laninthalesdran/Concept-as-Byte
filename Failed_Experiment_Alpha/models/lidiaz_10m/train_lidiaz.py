...
from lidiaz_model import LidiaZModel
...
TRAINING_BIN = os.path.join(BASE_DIR, 'lidiaz_training_parallel.bin')
CHECKPOINT_DIR = os.path.join(BASE_DIR, 'lidiaz_checkpoints')
LOG_FILE = os.path.join(BASE_DIR, 'lidiaz_training.log')
...
def train():
    ...
    logger.info("=" * 60)
    logger.info("LidiaZ (The Translator) — Ludwik Zamenhof Method")
    logger.info("=" * 60)
